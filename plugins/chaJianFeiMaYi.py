...
config = plugin.Form({
    'G_fmy_config_ql_config': plugin.Form.string().title('青龙配置').default(''),
    'G_fmy_config_ql_envname': plugin.Form.string().title('变量名称').default('G_fmy'),
    'G_fmy_config_ql_var_name': plugin.Form.string().title('飞蚂蚁变量名称').default('G_fmy'),
})
_CONFIG_FIELD_MAP = {
