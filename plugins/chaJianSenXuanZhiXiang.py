...
config = plugin.Form({
    ...
    'G_szyx_config_ql_config': plugin.Form.string().title('青龙容器').default('').description('用丨分割三个参数'),
    'G_szyx_config_ql_envname': plugin.Form.string().title('青龙变量名').default('G_SZYX').description('提交到青龙的变量名'),
})
_CONFIG_FIELD_MAP = {
