...
config = plugin.Form({
    'dd_hqcsh_Qinglong': plugin.Form.string().title('设置对接容器').default('').description('你的变量需要添加到的容器？参数用丨分割'),
    'dd_hqcsh_osname': plugin.Form.string().title('提交到青龙的变量名').default('').description('青龙容器内车生活的变量名'),
})
_CONFIG_FIELD_MAP = {
