...
config = plugin.Form({
    ...
    'dd_pz_superior_account': plugin.Form.string().title('上级账号').default('').description('填写上级账号信息，格式：账号#密码，用于判断下级关系'),
    'dd_pz_free_proxy': plugin.Form.boolean().title('下级免费代挂').default(False).description('是否开启下级免费代挂功能'),
})
_CONFIG_FIELD_MAP = {
