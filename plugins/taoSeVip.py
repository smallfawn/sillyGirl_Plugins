...
config = form({
    ...
    's_taose_wxpusher_uids': form.string().title('WxPusher推送UID，多个用英文逗号分隔').default('').description('扫码关注：https://img-upload.example.invalid/a2f034a9cb69badfe18e364d32be70ea.png'),
    's_taose_notify': form.string().title('通知渠道').default('').description('检测通知推送渠道'),
})
_CONFIG_FIELD_MAP = {
