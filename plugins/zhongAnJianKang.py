...
config = plugin.Form({
    ...
    'dd_zajk_config_Qinglong': plugin.Form.string().title('设置对接容器').default('').description('你的变量需要添加到的容器？参数用丨分割，这个符号是中文的竖线(直接复制)'),
    'dd_zajk_config_osname': plugin.Form.string().title('青龙变量名').default('').description('青龙面板中众安健康脚本对应的环境变量名称'),
})
_CONFIG_FIELD_MAP = {
